                                        ...
                                        <div class="row">
                                            <div class="col-6 mt-2">
                                                <div class="form-floating">
                                                    <input class="form-control" id="postTitle" type="text" name="post_title" placeholder="Post Title" />
                                            ...
                                            <div class="col-6 mt-2">
                                                <div class="form-floating">
                                                    <input class="form-control" id="subTitle" type="text" name="post_subtitle" placeholder="Post Subtitle" />
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-input">
                                                    ...
                                                    <textarea name="post_details" id="postDetails" class="form-control" cols="50"></textarea>
                                                </div>
                                            </div>

                                            <button type="submit" name="add_post" class="btn btn-success col-3 mt-4 mx-auto">Add Post</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
