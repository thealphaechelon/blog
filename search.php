...
<body id="top">
    ...
    <section class="s-pageheader">
        <div class="row current-cat">
            <div class="column">
                <h1 class="h2">Result For: <?=ucfirst($search)?></h1>
            </div>
        </div>
    </section>
    ...
    <section class="s-bricks with-top-sep">
        ...
        <div class="masonry">
            ...
            <div class="bricks-wrapper h-group">
                ...
                <?php
                    $stmt = "SELECT * FROM categories c INNER JOIN posts p
                    ON p.post_category = c.id
                    WHERE post_title LIKE '%$search%' 
                    OR post_details LIKE '%$search%'";
                        ...
                        <div class="entry__header">
                            ...
                            <div class="entry__meta">
                                <span class="entry__cat-links">
                                    <a href="category?cat=<?=$post['category_slug'];?>"><?=$post['category_name'];?></a> 
                                </span>
                            </div>
